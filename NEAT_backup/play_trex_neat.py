...
if __name__ == "__main__":
    ...
    # 优先从环境变量获取checkpoint路径
    env_checkpoint_path = os.environ.get("NEAT_CHECKPOINT_PATH")
    if env_checkpoint_path:
        abs_saved_genome_path = env_checkpoint_path
        print(f"使用环境变量 NEAT_CHECKPOINT_PATH 指定的checkpoint: {abs_saved_genome_path}")
    else:
